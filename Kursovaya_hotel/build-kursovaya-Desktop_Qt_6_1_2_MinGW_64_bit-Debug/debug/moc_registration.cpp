...
#include <memory>
#include "../../kursovaya/registration.h"
...
QT_MOC_LITERAL(24, 0), // ""
QT_MOC_LITERAL(25, 17), // "on_back_2_clicked"
QT_MOC_LITERAL(43, 21) // "on_continue_2_clicked"

    },
    "registration\0mainWindow\0\0on_back_2_clicked\0"
...
void registration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&registration::mainWindow)) {
                *result = 0;
                return;
            }
        }
